...
export const FilesystemRequest: core.serialization.ObjectSchema<
    serializers.FilesystemRequest.Raw,
    Scrapybara.FilesystemRequest
...
export declare namespace FilesystemRequest {
