 ...
 *
 * Supported models:
 * - computer-use (1x agent credit if no apiKey)
 *
 * @param name - OpenAI model name @default "computer-use"
...
/**
 * Recommended OpenAI system prompt for Ubuntu instances
 */
export const UBUNTU_SYSTEM_PROMPT = `You have access to an Ubuntu VM with internet connectivity. You can install Ubuntu applications using the bash tool (prefer curl over wget).  
 ...
 */
export const BROWSER_SYSTEM_PROMPT = `You have access to a Chromium VM with internet connectivity. Chromium should already be open and running.  
...
/**
 * Recommended OpenAI system prompt for Windows instances
 */
export const WINDOWS_SYSTEM_PROMPT = `You have access to a Windows VM with internet connectivity and can interact with the Windows desktop using the computer tool.  
